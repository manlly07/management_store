    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <div class="container-fluid m-auto my-4 justify-content-center col-10" style="min-height: 81.5vh;">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-2 mb-2">
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#addCustommer">
                                Sửa thông tin đơn
                            </button>
                            <button class="btn btn-danger" id="cancel">Huỷ đơn hàng</button>
                        </div>
                    </div>
